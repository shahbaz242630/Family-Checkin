...
2. **Sprint 4 wave 3 is closed.** Merged: #55 (CB-038 siren, the multer allowlist, the ci.yml sync) and #56 (CB-083 WhatsApp template script). Phase 3 now has only these open: CB-028, CB-030 device half, CB-034's Terms/Privacy (decision 9), CB-040.
