...
- Sprint 1 (PRs #17 to #21), sprint 2 (#25 to #31), sprint 3 (#34 to #40, #42) and sprint 4 wave 1 (#43 to #46) are merged. Phase 1 is complete except CB-078. Phase 2 is complete in code; CB-022's audio waits on decision 3 and CB-083 is open. Phase 3 is nine rows further on: CB-029, CB-032 to CB-037, CB-039 and CB-041 are done, CB-027 is part done. `master` CI is green at `5811e59`.
- Tests: 95 spec files, 1002 tests across all projects; the compiled build boots in fake and configured mode. Acceptance: `docs/audits/2026-09-07/sprint3-wave2-acceptance.md` and `docs/audits/2026-09-07/sprint4-wave1-acceptance.md`.
...
5. Then Dependabot triage (11 PRs), the one-off Prettier formatting commit and the `format:check` CI gate — the formatting debt has now cost work in two consecutive waves. Next free backlog id: CB-087.
