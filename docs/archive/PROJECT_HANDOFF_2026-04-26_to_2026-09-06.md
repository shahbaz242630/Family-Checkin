...
ARCHIVED 2026-09-06 (frozen history, 2026-04-26 to 2026-09-06; the header date below was already stale). Current handoff: `PROJECT_HANDOFF.md` at the repo root; per-feature handoffs: `docs/handoffs/`. Line numbers in this file are cited by the feature handoffs; do not edit it.
