...
| Mobile  | `apps/mobile/src/services/{supabase,auth,auth-storage,biometric}.ts`, `apps/mobile/src/contexts/AuthContext.tsx`, `apps/mobile/src/hooks/{useAuth,useProfile,useDeepLinks}.ts`, `apps/mobile/src/components/auth/ProtectedRoute.tsx`, `apps/mobile/src/app/{_layout.tsx,index.tsx,(auth)/,auth/,(main)/settings/}`          |
