...
| Data    | `apps/backend/prisma/schema.prisma`; `apps/backend/prisma/migrations/` (11); `apps/backend/prisma/supabase_setup.sql` + 4 hosted RLS patches; `supabase/migrations/20260510181345_partitioned_operational_logs.sql`; `apps/backend/scripts/db/sql/20260905_partition_rls_hardening.sql` |
