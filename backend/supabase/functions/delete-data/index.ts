// Edge Function: Delete all user data but keep account
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Note: We keep subscriptions and user profile (account remains active)

    return new Response(
      JSON.stringify({ success: true, message: 'All data deleted. Account remains active.' }),
